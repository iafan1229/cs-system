...
> 본 문서는 (주)바이오컴 실무 과제(PPT 요구사항)에 맞추어 **발표·평가 친화적으로 재구성된 PRD**이다. 기능 나열이 아닌 **설계 의사결정의 근거(Trade-off)** 와 전체 흐름 이해를 최우선으로 한다.
...
본 PRD는 **과제 PPT 요구사항에 직접 대응**하도록 구성되었으며,
...
> 평가자가 "왜 이렇게 설계했는지"를 한 번에 이해할 수 있는 문서를 지향한다.
